...
public class DapAdoFic : IAdoFichin
{
    ...
    public Tablas.Usuario? UsuarioPorDni(uint dni, string pasword)
    

        public Usuario? UsuarioPorDni()
    //En caso de que exista un cajero, lo devuelve instanciado, caso contrario devuelve NULL.
        => _conexion.QueryFirstOrDefault<Usuario>(_queryUsuarioDNI, new { unDni = dni, unPasword = pasword });
